...
ENDPOINT_HEADERS = {
    ...
    "send_schema": EndpointSchema(access=EndpointAccess.OPEN), # TODO: make not open
    ...
    "test_tba_key": EndpointSchema(access=EndpointAccess.ADMIN),
    ...
    "dload": EndpointSchema(access=EndpointAccess.LOGIN),
